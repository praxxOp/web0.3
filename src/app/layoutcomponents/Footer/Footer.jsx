...
const Footer = () => {
  return (
    <div className="main__footer">
      <p className={sora.className}>For collaboration inquiries or work opportunities, feel free to contact me through, </p>
...
<div className="link__socials">
  ...
  <a href="https://www.instagram.com/praxx.dev?utm_source=qr&igsh=MW55Z21qZDRibWRyaQ==">INSTAGRAM</a>
  <a href="https://www.linkedin.com/in/prathamesh-shelke/">LINKEDIN</a>
...
<p className={sora.className}>© WEB3  INDIA LTD, 2023. ALL RIGHTS RESERVED</p>
    </div>
  )
}
